<template><div><h1 id="titanic-survival-prediction" tabindex="-1"><a class="header-anchor" href="#titanic-survival-prediction"><span>Titanic Survival Prediction</span></a></h1>
...
<p>On April 15, 1912, the luxury passenger liner Titanic, famously known as the &quot;unsinkable ship,&quot; collided with an iceberg and sank during its maiden voyage. Of the 2,224 passengers and crew, 1,502 lost their lives. This tragedy shocked the world and led to improvements in maritime safety regulations.</p>
<p>In this project, we will analyze the passenger data from the Titanic and attempt to answer the question, &quot;Which types of people were more likely to survive?&quot; By building a predictive model, we can identify key factors that influenced survival rates.</p>
<div class="knowledge-card">
  <div class="knowledge-card__title">
...
<p>The dataset used in this project contains information about 891 passengers aboard the Titanic. Each passenger's record includes the following features:</p>
<ul>
<li><strong>PassengerId</strong>: Passenger ID</li>
<li><strong>Survived</strong>: Survival status (0 = No, 1 = Yes)</li>
<li><strong>Pclass</strong>: Ticket class (1 = First class, 2 = Second class, 3 = Third class)</li>
...
<li><strong>Fare</strong>: Ticket fare</li>
<li><strong>Cabin</strong>: Cabin number</li>
<li><strong>Embarked</strong>: Embarkation port (C = Cherbourg, Q = Queenstown, S = Southampton)</li>
</ul>
<p>There are some missing values in the dataset, especially in the Age, Cabin, and Embarked features. Handling these missing values will be an important part of the data preprocessing.</p>
<h2 id="project-goals" tabindex="-1"><a class="header-anchor" href="#project-goals"><span>Project Goals</span></a></h2>
<ol>
<li>Explore and analyze Titanic passenger data.</li>
<li>Handle missing values and prepare features.</li>
<li>Build a classification model to predict passenger survival.</li>
<li>Evaluate model performance and interpret results.</li>
<li>Submit prediction results.</li>
</ol>
...
<h3 id="step-1-data-exploration-and-visualization" tabindex="-1"><a class="header-anchor" href="#step-1-data-exploration-and-visualization"><span>Step 1: Data Exploration and Visualization</span></a></h3>
<p>First, we need to load the data and conduct an initial exploration to understand the basic features and distribution of the data.</p>
...
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="step-2-data-preprocessing" tabindex="-1"><a class="header-anchor" href="#step-2-data-preprocessing"><span>Step 2: Data Preprocessing</span></a></h3>
<p>Next, we need to handle the missing values and convert categorical features into formats that are usable by the model.</p>
<div class="language-python line-numbers-mode" data-highlighter="prismjs" data-ext="py"><pre v-pre><code><span class="line"><span class="token comment"># Handle missing age data</span></span>
...
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="step-3-model-building-and-evaluation" tabindex="-1"><a class="header-anchor" href="#step-3-model-building-and-evaluation"><span>Step 3: Model Building and Evaluation</span></a></h3>
<p>Now, we can build classification models and evaluate their performance.</p>
<div class="language-python line-numbers-mode" data-highlighter="prismjs" data-ext="py"><pre v-pre><code><span class="line"><span class="token keyword">from</span> sklearn<span class="token punctuation">.</span>model_selection <span class="token keyword">import</span> train_test_split<span class="token punctuation">,</span> cross_val_score</span>
...
<p>We can further improve the model's performance through hyperparameter tuning.</p>
...
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="step-5-predicting-on-the-test-set" tabindex="-1"><a class="header-anchor" href="#step-5-predicting-on-the-test-set"><span>Step 5: Predicting on the Test Set</span></a></h3>
<p>Finally, we use the best model to make predictions on the test set.</p>
<div class="language-python line-numbers-mode" data-highlighter="prismjs" data-ext="py"><pre v-pre><code><span class="line"><span class="token comment"># Load the test data</span></span>
...
<p>Through our analysis and modeling, we found the following factors significantly influenced Titanic passengers' survival rates:</p>
<ol>
<li><strong>Gender</strong>: Women had a significantly higher survival rate than men.</li>
<li><strong>Passenger Class</strong>: First-class passengers had a higher survival rate than second and third-class passengers.</li>
<li><strong>Age</strong>: Children had a higher survival rate than adults.</li>
<li><strong>Family Size</strong>: Passengers from medium-sized families had a higher survival rate.</li>
<li><strong>Title</strong>: Titles reflecting social status were associated with survival rates.</li>
</ol>
<p>These findings align with historical records, reflecting the &quot;women and children first&quot; policy and the impact of social class on survival chances.</p>
<h2 id="advanced-challenges" tabindex="-1"><a class="header-anchor" href="#advanced-challenges"><span>Advanced Challenges</span></a></h2>
<p>If you've completed the basic tasks, you can try the following advanced challenges:</p>
<ol>
<li><strong>Feature Engineering</strong>: Try creating more meaningful features, such as fare range, age groups, etc.</li>
<li><strong>Model Ensemble</strong>: Use voting or stacking methods to combine predictions from multiple models.</li>
<li><strong>Survival Probability Analysis</strong>: Instead of predicting survival, analyze survival probabilities for different feature combinations.</li>
<li><strong>Visualization</strong>: Create more advanced visualizations, such as decision tree visualizations or survival heatmaps.</li>
<li><strong>Missing Value Handling</strong>: Try more complex methods for handling missing values, such as imputation based on similar passengers' features.</li>
</ol>
<h2 id="conclusion-and-reflection" tabindex="-1"><a class="header-anchor" href="#conclusion-and-reflection"><span>Conclusion and Reflection</span></a></h2>
<p>Through this project, we learned how to handle a complete classification problem, from data exploration to model deployment. The Titanic dataset, although small, contains common challenges in data mining, such as handling missing values, feature engineering, and model selection.</p>
<p>In practical applications, such analysis can help us understand the key factors influencing a particular outcome, leading to more effective strategies and policies. For example, in disaster management, similar analyses can help identify high-risk groups and prioritize resource allocation.</p>
<h3 id="reflective-questions" tabindex="-1"><a class="header-anchor" href="#reflective-questions"><span>Reflective Questions</span></a></h3>
<ol>
<li>Does our model exhibit any biases? How can we ensure fairness in predictions?</li>
<li>How can we apply this analysis approach to predict other disasters or events?</li>
<li>Besides accuracy, what other metrics can we use to evaluate model effectiveness?</li>
</ol>
